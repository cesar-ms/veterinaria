    ...
    'menu' => [
       ...
       /*  [
        ...
        [
            ...
            'icon' => 'fas fa-fw fa-solid fa-store',
            'active' => ['admin/ventas/index'],
            'active' => ['admin/ventas/create'],
            'active' => ['admin/ventas/show'],
            'active' => ['admin/ventas/*/edit'],
            'active' => ['admin/ventas/destroy'],
        ...
        [
            ...
            'icon' => 'fas fa-fw fa-solid fa-pen',
        ...
        [
            ...
            'active' => ['admin/services/index'],
            'active' => ['admin/services/create'],
            'active' => ['admin/services/show'],
            'active' => ['admin/services/*/edit'],
            'active' => ['admin/services/destroy'],
        ...
        [
            ...
            'icon' => 'fas fa-fw fa-solid fa-chart-bar',
            'route'  => 'admin.ventas.statistics',
            'active' => ['admin/ventas/statistics'],
            'can'  =>   'admin.ventas.statistics'
        ],
        [
            'text'       => 'Gráfico de servicios',
            'icon' => 'fas fa-fw fa-solid fa-chart-line',
            'route'  => 'admin.services.statistics',
            'active' => ['admin/services/statistics'],
            'can'  =>   'admin.services.statistics'
        ],
    ],
        ...
        'Datatables' => [
            ...
            'files' => [
                ...
                [
                    'type' => 'css',
                    'asset' => false,
                    'location' => '//cdn.datatables.net/buttons/2.0.0/css/buttons.dataTables.min.css',
                ],
            ],
        ],
        'Select2' => [
        ...
        'snackbar' => [
            ...
            'files' => [
                [
                    'type' => 'css',
                    'asset' => false,
                    'location' => '//cdn.jsdelivr.net/npm/node-snackbar@latest/dist/snackbar.min.css',
                ],
                [
                    'type' => 'js',
                    'asset' => false,
                    'location' => '//cdn.jsdelivr.net/npm/node-snackbar@0.1.16/dist/snackbar.min.js',
                ],
            ],
        ],
        'nicescroll' => [
            ...
            'files' => [
                [
                    'type' => 'js',
                    'asset' => false,
                    'location' => '//cdn.jsdelivr.net/npm/jquery.nicescroll@3.7.6/dist/jquery.nicescroll.min.js',
                ],
                [
                    'type' => 'js',
                    'asset' => false,
                    'location' => '//cdn.jsdelivr.net/npm/jquery.nicescroll@3.7.6/dist/jquery.nicescroll.js',
                ],
            ],
        ],
        'onScan' => [
            ...
            'files' => [
                [
                    'type' => 'js',
                    'asset' => false,
                    'location' => '//cdn.jsdelivr.net/npm/onscan.js@1.5.2/onscan.min.js',
                ],
                [
                    'type' => 'js',
                    'asset' => false,
                    'location' => '//cdn.jsdelivr.net/npm/onscan.js@1.5.2/onscan.js',
                ],
            ],
        ],
    ],
